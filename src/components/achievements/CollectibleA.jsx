        ...
        <div className='achieve-home'>
            ...
            <section className='extra-collect-tips'>
                ...
                <ul>
                    ...
                    <ul>
                        <li>The same bobblehead stand can be crafted and placed in any of your settlements (Please note that only 1 of each bobblehead officially exists in the game and more cannot be found without the use of cheats and/or mods)</li>
                    </ul>
